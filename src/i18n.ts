...
const ru: Dict = {
  ...
  "chat.digest": "Свернуть в резюме",
  "chat.digesting": "Сворачиваю…",
  "chat.digestBody": "Старые сообщения ({n}) будут удалены и заменены подробным резюме; последние шесть останутся как есть. Отменить нельзя.",
  "step.chatBackedUp": "копия переписки сохранена: {path}",
  "chat.digestLabel": "Резюме прежней переписки",
  "chat.digestHint": "Что агент помнит о свёрнутых письмах — можно править руками",
  "toast.digested": "Переписка свёрнута в резюме, копия писем — в chats/backups",
...
const en: Dict = {
  ...
  "chat.digest": "Fold into a digest",
  "chat.digesting": "Folding…",
  "chat.digestBody": "The older messages ({n}) will be deleted and replaced by a detailed digest; the last six stay as they are. This cannot be undone.",
  "chat.digestLabel": "Digest of the earlier correspondence",
  "chat.digestHint": "What the agent remembers of the folded letters — editable by hand",
  "toast.digested": "The correspondence was folded into a digest; a copy of the letters is in chats/backups",
