...
const ru: Dict = {
  ...
  "step.note": "заметка {name}: {text}",
  "step.gift": "подарок {name} → {title}",
  "step.tags": "метки {name} (+{n})",
  "step.appendChat": "в переписку {id}: {text}",
  "step.updateProfile": "анкета {name} — {fields}",
  "step.replacePersona": "переписать персону {name}",
...
const en: Dict = {
  ...
  "step.note": "note on {name}: {text}",
  "step.gift": "gift {name} → {title}",
  "step.tags": "tags on {name} (+{n})",
  "step.appendChat": "into the thread {id}: {text}",
  "step.updateProfile": "profile {name} — {fields}",
  "step.replacePersona": "rewrite the persona of {name}",
